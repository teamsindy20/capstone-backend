...
CREATE OR REPLACE FUNCTION get_delivery_charge_from (store_id bigint, out delivery_charge int) LANGUAGE SQL IMMUTABLE AS $$
...
CREATE OR REPLACE FUNCTION create_post (
    ...
    INSERT INTO post (content, store_id, image_urls)
...
SELECT create_store (
    ...
    FALSE,
    1,
    ARRAY ['크림치즈 타르트 1개', '쇼콜라 카스테라 1개'],
    ARRAY ['콘 프레즐 1개', '플레인 머핀 1개'],
    1,
    2,
...
SELECT create_store (
    ...
    FALSE,
    1,
    ARRAY ['화이트초코 브라우니 1개', '바질치즈스콘 1개'],
    ARRAY ['딸기크림치즈베이글 1개', '소프트빅초코쿠키 1개'],
    10,
    19,
